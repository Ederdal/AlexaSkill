    ...
    handle(handlerInput) {
        ...
        switch (pregunta) {
            case 'quien creo esta skill':
                speechText = 'Mi nombre es Edgar Cruz Salas.';
                break;
            ...
            case 'cual es su grupo o cantante favorito':
                speechText = 'Mi grupo favorito es el Tri "Queremos rooooooooooock"';
                break;
            default:
                speechText = 'Lo siento, no tengo una respuesta para eso. Qué triste no saberlo.';
        }
